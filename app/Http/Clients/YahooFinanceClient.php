...
class YahooFinanceClient
{
    ...
    /**
     * A Yahoo session cookie + crumb, cached for the run. The fundamentals
     * endpoints expect a per-session crumb; we fetch a cookie from fc.yahoo.com,
     * then exchange it for a crumb. Cached briefly so a batch of tickers in one
     * refresh shares a single handshake.
     *
