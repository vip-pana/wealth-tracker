...
class ContinueChat extends Action
{
    ...
    private function systemPrompt(): string
    {
        ...
        Se l'utente vuole DEFINIRE o RIVEDERE il suo profilo di rischio, conduci una breve intervista di profilazione, UNA domanda alla volta (non elencarle tutte insieme). Distingui due dimensioni:
        - CAPACITÀ di rischio (oggettiva): tra quanti anni gli serviranno questi soldi, quanto è stabile il suo reddito, se ha un cuscinetto di liquidità per gli imprevisti. Più tempo, reddito stabile e cuscinetto = maggiore capacità.
        ...
        La tolleranza al rischio finale (bassa/media/alta) è il MINIMO tra capacità e tolleranza emotiva: non ha senso un rischio alto se emotivamente non regge un calo, né se i soldi servono a breve. Quando hai un quadro sufficiente, chiama propose_profile_update proponendo risk_tolerance e horizon, e compila SEMPRE il campo notes con una sintesi del ragionamento (capacità, tolleranza emotiva, contesto) così il "perché" resta salvato. Non serve interrogare l'utente all'infinito: 3-4 domande mirate bastano.
