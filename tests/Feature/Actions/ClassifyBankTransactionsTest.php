...
class ClassifyBankTransactionsTest extends TestCase
{
    ...
    {
        $tx = $this->tx('t1', -100.0, ['PAGAMENTO POS EFFETTUATO IL 25/04/2026 ... PRESSO Revolut**8361* Dublin']);
    ...
    {
        $tx = $this->tx('t3', 100.0, ['Apple Pay Top-Up by *8222']);
    ...
    {
        $tx = $this->tx('t8', -100.0, ['PRESSO Revolut**8361*'], manual: true, flowType: BankTransaction::FLOW_EXPENSE);
