...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // accounts, the connection health (host proxy up, 8h session valid) is
        // global, not per-asset — so a failed sync stays visible in Settings
        // after the one-time refresh toast is gone. ok | failed | null.
